 ...
 */
public abstract class DefaultVisitor implements Visitor<Object> {
    ...
    @Override public Object visit(VarDeclStmt varDeclStmt) {
    ...
    @Override public Object visit(Precondition precondition) {
        return new Precondition((Expr) precondition.getCondition().accept(this));
    }

    @Override public Object visit(Postcondition postcondition) {
        return new Postcondition((Expr) postcondition.getCondition().accept(this));
    }

    @Override public Object visit(CandidatePrecondition candidatePrecondition) {
        return null;
    }

    @Override public Object visit(CandidatePostcondition candidatePostcondition) {
        return null;
    }

    @Override public Object visit(AssignStmt assignStmt) {
    ...
    @Override public Object visit(AssertStmt assertStmt) {
        return new AssertStmt((Expr) assertStmt.getCondition().accept(this));
    }

    @Override public Object visit(AssumeStmt assumeStmt) {
        return new AssumeStmt((Expr) assumeStmt.getCondition().accept(this));
    }

    @Override public Object visit(HavocStmt havocStmt) {
        return new HavocStmt((VarRef) havocStmt.getVarRef().accept(this));
    }

    @Override public Object visit(CallStmt callStmt) {
    ...
    @Override public Object visit(IfStmt ifStmt) {
    ...
    @Override public Object visit(WhileStmt whileStmt) {
        ...
        List<LoopInvariant> invariants = whileStmt.getInvariants().stream()
            .map(i -> (LoopInvariant) i.accept(this))
            .collect(Collectors.toList());
        return new WhileStmt(condition, whileBlock, invariants);
    }

    @Override public Object visit(BlockStmt blockStmt) {
    ...
    @Override public Object visit(Invariant invariant) {
        return new Invariant((Expr) invariant.getCondition().accept(this));
    }

    @Override public Object visit(CandidateInvariant candidateInvariant) {
        return null;
    }

    @Override public Object visit(VarRef varRef) {
        return new VarRef(varRef.getVar());
    }

    @Override public Object visit(TernaryExpr ternaryExpr) {
    ...
    @Override public Object visit(BinaryExpr binaryExpr) {
